...
int main()
{
    ...
    int randomInput;
    cout << "Enter seed to random number generator" << endl;
    cin >> randomInput;
    ranGen.seed(randomInput);

    cout << "1. Test 2D constructor" << endl << "2. Test 3D constructor" << endl << "3. Test ScaleFactor" << endl
         << "4. Largest/smallest area of 2D shapes" << endl << "5. Largest/smallest area of 3D shapes" << endl;
    int testNum;
    cin >> testNum;
